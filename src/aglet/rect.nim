...
func x*[T](rect: Rect[T]): T =
  ## Returns the X position of the rectangle.
  rect.position.x

func y*[T](rect: Rect[T]): T =
  ## Returns the Y position of the rectangle.
  rect.position.y

func width*[T](rect: Rect[T]): T =
  ## Returns the width of the rectangle.
  rect.size.x

func height*[T](rect: Rect[T]): T =
  ## Returns the height of the rectangle.
  rect.size.y

func left*[T](rect: Rect[T]): T =
  ## Returns the left boundary of the rectangle.
  rect.x

func right*[T](rect: Rect[T]): T =
  ## Returns the right boundary of the rectangle.
  rect.x + rect.width

func top*[T](rect: Rect[T]): T =
  ## Returns the top boundary of the rectangle.
  rect.y

func bottom*[T](rect: Rect[T]): T =
...
template alias(T, suffix, doc1, doc2) {.inject.} =
  ...
  func `rect suffix`*(position, size: Vec2[T]): Rect[T] =
    doc1
